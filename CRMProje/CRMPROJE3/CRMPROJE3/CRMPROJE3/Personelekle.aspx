<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="Personelekle.aspx.cs" Inherits="CRMPROJE3.Personelekle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div id="gridContainer">
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="dsPersonel" KeyFieldName="id" Theme="IOS" EnableTheming="True" Width="100%">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="Sifre" VisibleIndex="10" ShowInCustomizationForm="True" Caption="Şifre"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Maasi" VisibleIndex="11" ShowInCustomizationForm="True" Caption="Maaş"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="id" ReadOnly="True" VisibleIndex="12" ShowInCustomizationForm="True" Visible="False">
        ...
        <asp:SqlDataSource ID="dsPersonel" runat="server" 
            ...
            SelectCommand="SELECT [id], [Personel_Numarası], [Ad], [Soyad], [Cinsiyet], [Dogum_tarihi], [Baslama_Tarihi], [Departman_Numara], [Telefon_Numarası], [Email], [Sifre], [Maasi] FROM [Personel]"
            InsertCommand="INSERT INTO [Personel] ([Personel_Numarası], [Ad], [Soyad], [Cinsiyet], [Dogum_tarihi], [Baslama_Tarihi], [Departman_Numara], [Telefon_Numarası], [Email], [Sifre], [Maasi]) VALUES (@Personel_Numarası, @Ad, @Soyad, @Cinsiyet, @Dogum_tarihi, @Baslama_Tarihi, @Departman_Numara, @Telefon_Numarası, @Email, @Sifre, @Maasi)"
            UpdateCommand="UPDATE [Personel] SET [Personel_Numarası] = @Personel_Numarası, [Ad] = @Ad, [Soyad] = @Soyad, [Cinsiyet] = @Cinsiyet, [Dogum_tarihi] = @Dogum_tarihi, [Baslama_Tarihi] = @Baslama_Tarihi, [Departman_Numara] = @Departman_Numara, [Telefon_Numarası] = @Telefon_Numarası, [Email] = @Email, [Sifre] = @Sifre, [Maasi] = @Maasi WHERE [id] = @id">
            <UpdateParameters>
