    ...
    public partial class Satis : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //Sayfanın adını al
                string StokGrafikPage = System.IO.Path.GetFileName(Request.Url.AbsolutePath);
                if (StokGrafikPage == "StokSatis.aspx")
                {
                    btnStokGrafik.Visible = true;
                }
                else
                {
                    btnStokGrafik.Visible = false;
                }

                //Sayfanın adını al
                string SozlesmePage = System.IO.Path.GetFileName(Request.Url.AbsolutePath);

                if (SozlesmePage == "GorusmelerSatis.aspx")
                {
                ...
                //Butonun Görünürlüğü
                if (Irsaliyepage == "IrsaliyeSatis.aspx")
                {
                ...
                if (currentPage == "StokSatis.aspx" || currentPage == "IrsaliyeSatis.aspx")
                {
