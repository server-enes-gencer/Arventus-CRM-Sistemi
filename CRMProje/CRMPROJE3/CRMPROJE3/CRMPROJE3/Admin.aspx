<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="CRMPROJE3.Admin2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="container mb-5">
    ...
    <div class="container" style="margin-bottom:15vh;>
     <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="dsRandevu" ClientIDMode="AutoID" Start="2024-05-19" Theme="iOS" Width="100%">
         <Views>
