<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="Musteriekle.aspx.cs" Inherits="CRMPROJE3.Musteriekle" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
    ...
    <asp:ImageButton ID="pdfbutonstokmst" runat="server" ImageUrl="İmage/pdf.png" Width="30" Height="30" OnClick="pdfbutonstok_Click"/>
          ...
          <div class="row">
        <div class="col-auto" style="margin-right: 95vh;">
